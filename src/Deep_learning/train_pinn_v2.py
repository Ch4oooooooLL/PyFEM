...
def main():
    ...
    parser.add_argument('--structure_file', type=str, default=os.path.join(ROOT_DIR, 'configs', 'structure.yaml'))
    ...
    parser.add_argument('--output_dir', type=str, default=os.path.join(ROOT_DIR, 'outputs', 'checkpoints'))
