...
from Deep_learning.models.pinn_model import PINNDamagePredictor, PINNLoss
from Deep_learning.models.pinn_model_v2 import PINNDamagePredictorV2
from Deep_learning.utils.metrics import compute_metrics, EarlyStopping
...
def main() -> None:
    ...
    parser.add_argument('--config', type=str, default=os.path.join(ROOT_DIR, 'configs', 'dataset_config.yaml'))
    ...
    ckpt_dir = os.path.join(ROOT_DIR, 'outputs', 'checkpoints') if args.output_dir is None else _resolve_path(ROOT_DIR, args.output_dir)
