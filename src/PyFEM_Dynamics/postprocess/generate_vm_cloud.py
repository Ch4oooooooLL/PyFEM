...
from PyFEM_Dynamics.pipeline.data_gen import generate_load_matrix, run_fem_solver
from PyFEM_Dynamics.postprocess.plotter import Plotter
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default=os.path.join(ROOT_DIR, "outputs", "postprocess", "vm_cloud"),
    )
