...
from PyFEM_Dynamics.solver.integrator import NewmarkBetaSolver
from PyFEM_Dynamics.solver.stress_recovery import recover_truss_stress_time_history
...
def generate_dataset(
    ...
    Args:
        config_path: Path to config file (default: configs/dataset_config.yaml)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Path to config file (default: configs/dataset_config.yaml)'
    )
    parser.add_argument(
        '--jobs', '-j',
        type=int,
