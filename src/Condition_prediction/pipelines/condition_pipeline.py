...
from PyFEM_Dynamics.pipeline.data_gen import run_fem_solver
...
def run_condition_pipeline(config_path: str, output_dir_override: str | None = None) -> Dict[str, Any]:
    ...
    root_output_dir = output_dir_override or output_cfg.get("root_dir", "../outputs/inference")
    ...
    checkpoint_path = _resolve_path(config_dir, dl_cfg.get("checkpoint", "../outputs/checkpoints/gt_best.pth"))
