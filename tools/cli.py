...
REQUIREMENT_FILES = (
    ...
    ROOT_DIR / "Deep_learning" / "requirements.txt",
)
BOOTSTRAP_IMPORTS = (
    "numpy",
    "scipy",
    ...
    command_fields: dict[str, list[WizardField]] = {
        ...
        "static": [
            WizardField(
                ...
                kind="path",
                default=ROOT_DIR / "structure.yaml",
            ),
        ],
        "dataset": [
            WizardField(
                ...
                kind="path",
                default=ROOT_DIR / "dataset_config.yaml",
            ),
            WizardField(
                name="jobs",
        ...
        "predict": [
            WizardField(
                ...
                kind="path",
                default=ROOT_DIR / "condition_case.yaml",
            ),
            WizardField(
                name="output_dir",
...
Examples:
    ...
    ./run.sh predict --config condition_case.yaml
        """.strip(),
    )
